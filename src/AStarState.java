...
public class AStarState
{
    ...
    {
        float minimalCost = 100_000_000;
        Waypoint minimal_waypoint = null;

        for (Waypoint waypoint: openWaypoints.values()){
            if (waypoint.getTotalCost() < minimalCost) {
                minimalCost = waypoint.getTotalCost();
                minimal_waypoint = waypoint;
            }
        }
        return minimal_waypoint;
    }
